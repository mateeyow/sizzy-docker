...
const questions = [
  ...
  },
  {
    ...
    answer: (
      <div>
        For now, it doesn't make sense because there's mix of various devices and sizes which can be in either portrait on landscape.
        So if you imagine a situation where you have a huge iPad and a small iPhone next to it and the scroll is synchronized, with one scroll on the iPhone you're going to reach the end of the site on the iPad.
        So the scroll won't really be "synced". This feature won't be implemented until there's a proper solution so the scroll is not actually "synced" but it's focusing on the same portion of the page on all devices.
      </div>
    )
  },
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        {' '}
        (a zero-configuration command-line http server). constructor
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        , so you freely explore what it does.

        The extension has 2 basic functionalities:
        <ol>
          <li>
            When clicking the "Sizzy" button, it will open the current website in Sizzy.
          </li>
          <li>
            It blocks "x-frame-options" headers from the requests, so you can embed most of the websites that prevent embedding. any site you want.
            {' '}
          </li>
        </ol>
        ...
        I would understand your concert if the extension had a closed source, but you have nothing to worry about.
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        .
        Development will continue as usual but it would help greatly if you can help and support this project with a one time or a recurring donation
        {' '}
        <a target="_blank" href="https://opencollective.com/sizzy">
          {' '}on OpenCollective
        </a>
        . You can also become a sponsor of the app!
        If you would like to discuss a different way of supporting Sizzy, you can
        {' '}
