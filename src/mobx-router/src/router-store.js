...
class RouterStore {
  ...
  @action goTo(view, paramsObj, store, queryParamsObj) {
    ...
    const beforeExitResult = rootViewChanged &&
      this.currentView &&
    ...
    const beforeEnterResult = rootViewChanged && view.beforeEnter
      ? view.beforeEnter(view, currentParams, store, currentQueryParams)
      : true;
